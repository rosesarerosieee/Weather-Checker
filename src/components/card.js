...
class Card extends Component {
    ...
    handleCheckWeather = async () => {
        try {
            ...
            this.setState({ error: error.message, weather: null, backgroundClass: '' });
        }
    }
    ...
    render() {
        ...
        const country = locationParts[1] ? locationParts[1].trim().toUpperCase() : '';
                    ...
                    <div className="Card">
                        ...
                        {weather && (
                            <div className="weather-temps">
                                <h2 className="country">{weather.name}{country && `, ${country}`}</h2>
